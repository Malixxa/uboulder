...
(function(c){var e=function(){function b(a,b,d,c,e,k,g,h){var f=this;this.media=[];this.pricing=[];this.pointSet=this.edit=this.loading=!1;a.vm=this;this.scope=a;this.http=d;this.location=c;this.window=e;this.geoService=g;this.offlineService=h;this.infrastructure=INFRASTRUCTURE;this.offlineService.isOnline()?(a=b.id||"new","new"===a?this.createSpot():this.loadSpot(a)):this.location.path("/app/offline");this.scope.$on("geocode",function(a,b,d){return f.geocodeFinished(b,d)})}b.prototype.addMedia=function(){this.media.push(new c.Media)};
...
function(a,b){b?(this.window.alert(b),this.loading=!1):this.edit?(this.spot.address=a,this.save()):(this.spot.address=a,this.insert())};b.prototype.insert=function(){var a=this;this.loading=!0;this.handleMedias();this.handlePricings();this.http.post(jsRoutes.controllers.Application.createSpot().absoluteURL(),this.spot).success(function(b,d){a.spot=b;a.location.path("/app/spot/"+a.spot.id)}).error(function(b,d){a.loading=!1})};b.prototype.save=function(){var a=this;this.loading=!0;this.handleMedias();
this.handlePricings();this.http.put(jsRoutes.controllers.Application.updateSpot().absoluteURL(),this.spot).success(function(b,d){a.spot=b;a.location.path("/app/spot/"+a.spot.id)}).error(function(a,b){})};b.prototype.handleMedias=function(){for(var a=this.media.length;a--;)this.media[a].url||this.media.splice(a,1);this.spot.media=this.spot.media.concat(this.media)};b.prototype.handlePricings=function(){for(var a=this.pricing.length;a--;)this.pricing[a].description||this.pricing.splice(a,1);this.spot.pricing=
this.spot.pricing.concat(this.pricing)};b.prototype.createSpot=function(){this.edit=!1;this.spot=new c.Spot;this.spot.address=new c.Address;this.createMap()};b.prototype.loadSpot=function(a){var b=this;this.pointSet=this.edit=!0;this.http.get(jsRoutes.controllers.Application.retrieveSpot(a).absoluteURL()).success(function(a,c){b.spot=a;b.spot||b.location.path("/app/404").replace()}).error(function(a,c){b.location.path("/app/404").replace()})};b.prototype.createMap=function(){var a=this,b=null;this.geoService.current().then(function(a){d.setCenter(new google.maps.LatLng(a.coords.latitude,
a.coords.longitude))});var d=new google.maps.Map(document.getElementById("map"),{center:{lat:48.20817400000001,lng:16.373819},zoom:15});google.maps.event.addListener(d,"click",function(c){var e=c.latLng.lat(),k=c.latLng.lng();a.spot.address.position.lat=e;a.spot.address.position.lon=k;a.pointSet=!0;null==b?b=new google.maps.Marker({position:c.latLng,map:d}):b.setPosition(c.latLng)})};b.$inject="$scope $stateParams $http $location $window $timeout geoService offlineService".split(" ");return b}();
c.EditSpotCtrl=e})(app||(app={}));
(function(c){var e=function(){function b(a,b,d,c,e,k,g){var h=this;this.hasImage=!1;this.slideIndex=0;this.finished=!1;this.scope=a;this.scope.vm=this;this.http=b;this.location=d;this.window=k;this.sce=e;this.offlineService=g;this.oratio=this.sce.trustAsResourceUrl("//www.orat.io/js/widget/stmt.inc.min.js");this.loadSpot(c.id||"0");this.scope.$on("online",function(a){h.loadFinish()})}b.prototype.loadSpot=function(a){var b=this;localforage.getItem(a,function(d){b.spot=d;b.spot?(b.offlineService.isOnline()&&
