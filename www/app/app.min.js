var app;
(function(c){var d=function(){return function(l,b,f,c,d,h,k,g){"undefined"===typeof l&&(l=null);"undefined"===typeof b&&(b=null);"undefined"===typeof f&&(f=null);"undefined"===typeof c&&(c=!1);"undefined"===typeof d&&(d=new a);"undefined"===typeof h&&(h=[]);"undefined"===typeof k&&(k=[]);"undefined"===typeof g&&(g=[]);this.id=l;this.title=b;this.description=f;this.active=c;this.address=d;this.media=h;this.pricing=k;this.infrastructure=g}}();c.Spot=d;var b=function(){return function(a,b){"undefined"===typeof a&&
...
d})(app||(app={}));
(function(c){var d=function(){function b(a,b,e,f,c,d,h,k){var g=this;this.offset=0;this.radius=3;this.choose=this.lon=this.lat=0;this.phrase=null;this.spots=[];this.showLoad=this.loading=!1;this.scope=a;this.scope.vm=this;this.http=b;this.location=e;this.window=f;this.resource=c;this.timeout=d;this.offlineService=h;this.geoService=k;this.geoService.current().then(function(a){g.lat=a.coords.latitude;g.lon=a.coords.longitude;g.loadNearby()});this.window.onscroll=function(a){a=$(window).innerHeight()+$(window).scrollTop();
var b=$(document).height();a+200>=b&&g.showLoad&&(0==g.choose?g.loadNearby():g.loadByCity())}}b.prototype.reset=function(){this.offset=0;this.spots=[];0==this.choose?this.loadNearby():this.loadByCity()};b.prototype.parseRadius=function(){this.radius=parseInt(this.radius.toString())};b.prototype.loadByCity=function(){var a=this;this.loading=!0;this.http.get(jsRoutes.controllers.Application.findByCity(this.phrase,this.offset).absoluteURL()).success(function(b,e){a.spots=a.spots.concat(b);a.offset+=
10;a.loading=!1;a.offlineService.setOnline();a.saveOffline();a.spots.length==a.offset&&(a.showLoad=!0)}).error(function(b,e){a.loading=!1;a.offlineService.setOffline();a.loadOffline()})};b.prototype.loadNearby=function(){var a=this;this.loading=!0;this.http.get(jsRoutes.controllers.Application.findNearby(this.lat,this.lon,1E3*this.radius,this.offset).absoluteURL()).success(function(b,e){a.spots=a.spots.concat(b);a.offset+=10;a.loading=!1;a.offlineService.setOnline();a.saveOffline();a.spots.length==
a.offset&&(a.showLoad=!0)}).error(function(b,e){a.loading=!1;a.offlineService.setOffline();a.loadOffline()})};b.prototype.redirect=function(a){this.location.path("/spot/"+a)};b.prototype.loadOffline=function(){var a=this;this.showLoad=!1;for(var b=0;10>b;b++)localforage.getItem("spot-"+b,function(b){b&&a.timeout(function(){return a.spots.push(b)})})};b.prototype.saveOffline=function(){this.spots.forEach(function(a,b,e){localforage.setItem("spot-"+b,a)})};b.$inject="$scope $http $location $window $resource $timeout offlineService geoService".split(" ");
return b}();c.HomeCtrl=d})(app||(app={}));
(function(c){var d=function(){function b(a,b,e,f,c,d,h){var k=this;this.media=[];this.pricing=[];this.edit=this.loading=!1;a.vm=this;this.scope=a;this.http=e;this.location=f;this.window=c;this.geoService=h;this.infrastructure=INFRASTRUCTURE;a=b.id||"new";"new"===a?this.createSpot():this.loadSpot(a);this.scope.$on("geocode",function(a,b,l){return k.geocodeFinished(b,l)})}b.prototype.addMedia=function(){this.media.push(new c.Media)};b.prototype.deleteMedia=function(a){this.media.splice(a,1)};b.prototype.addPricing=
...
this.loading=!1):this.edit?(this.spot.address=a,this.save()):(this.spot.address=a,this.insert())};b.prototype.insert=function(){var a=this;this.loading=!0;this.handleMedias();this.http.post(jsRoutes.controllers.Application.createSpot().absoluteURL(),this.spot).success(function(b,e){a.spot=b;a.location.path("/spot/"+a.spot.id)}).error(function(b,e){a.loading=!1})};b.prototype.save=function(){var a=this;this.loading=!0;this.handleMedias();this.handlePricings();this.http.put(jsRoutes.controllers.Application.updateSpot().absoluteURL(),
this.spot).success(function(b,e){a.spot=b;a.location.path("/spot/"+a.spot.id)}).error(function(a,b){})};b.prototype.handleMedias=function(){for(var a=this.media.length;a--;)this.media[a].url||this.media.splice(a,1);this.spot.media=this.spot.media.concat(this.media)};b.prototype.handlePricings=function(){for(var a=this.pricing.length;a--;)this.pricing[a].description||this.pricing.splice(a,1);this.spot.pricing=this.spot.pricing.concat(this.pricing)};b.prototype.createSpot=function(){this.edit=!1;this.spot=
new c.Spot;this.spot.address=new c.Address;this.createMap()};b.prototype.loadSpot=function(a){var b=this;this.edit=!0;this.http.get(jsRoutes.controllers.Application.retrieveSpot(a).absoluteURL()).success(function(a,f){b.spot=a;b.spot||b.location.path("/404").replace()}).error(function(a,f){b.location.path("/404").replace()})};b.prototype.checkPosition=function(){return 0==this.spot.address.position.lat&&0==this.spot.address.position.lon?(this.window.alert("no point set"),!1):!0};b.prototype.createMap=
function(){var a=this,b=L.map("map");L.tileLayer("http://{s}.tile.osm.org/{z}/{x}/{y}.png",{attribution:'&copy; <a href="http://osm.org/copyright">OpenStreetMap</a> contributors',maxZoom:18}).addTo(b);var e=null;this.geoService.current().then(function(a){b.setView([a.coords.latitude,a.coords.longitude],13);e=L.marker([a.coords.latitude,a.coords.longitude]).addTo(b)});b.on("click",function(c){a.spot.address.position.lat=c.latlng.lat;a.spot.address.position.lon=c.latlng.lng;e?e.setLatLng(c.latlng):
e=L.marker([c.latlng.lat,c.latlng.lng]).addTo(b)})};b.$inject="$scope $routeParams $http $location $window $timeout geoService".split(" ");return b}();c.EditSpotCtrl=d})(app||(app={}));
(function(c){var d=function(){function b(a,b,e,c,d,m,h){var k=this;this.hasImage=!1;this.slideIndex=0;this.finished=!1;this.scope=a;this.scope.vm=this;this.http=b;this.location=e;this.window=m;this.sce=d;this.offlineService=h;this.oratio=this.sce.trustAsResourceUrl("//www.orat.io/js/widget/stmt.inc.min.js");this.loadSpot(c.id||"0");this.scope.$on("online",function(a){k.loadFinish()})}b.prototype.loadSpot=function(a){var b=this;localforage.getItem(a,function(c){b.spot=c;b.spot?(b.offlineService.isOnline()&&
...
L.marker([a,b]).addTo(c)};b.$inject="$scope $http $location $routeParams $sce $window offlineService".split(" ");return b}();c.SpotCtrl=d})(app||(app={}));
