var app;
(function(c){var e=function(){return function(k,d,b,c,e,g,h,f){"undefined"===typeof k&&(k=null);"undefined"===typeof d&&(d=null);"undefined"===typeof b&&(b=null);"undefined"===typeof c&&(c=!1);"undefined"===typeof e&&(e=new a);"undefined"===typeof g&&(g=[]);"undefined"===typeof h&&(h=[]);"undefined"===typeof f&&(f=[]);this.id=k;this.title=d;this.description=b;this.active=c;this.address=e;this.media=g;this.pricing=h;this.infrastructure=f}}();c.Spot=e;var b=function(){return function(a,d){"undefined"===typeof a&&
...
(function(c){var e=function(){function b(a,k,d,b,c,e,g,h){var f=this;this.offset=0;this.radius=3;this.choose=this.lon=this.lat=0;this.phrase=null;this.spots=[];this.showLoad=this.loading=!1;this.scope=a;this.scope.vm=this;this.http=k;this.location=d;this.window=b;this.resource=c;this.timeout=e;this.offlineService=g;this.geoService=h;this.geoService.current().then(function(a){f.lat=a.coords.latitude;f.lon=a.coords.longitude;f.loadNearby()});this.window.onscroll=function(a){a=$(window).innerHeight()+
$(window).scrollTop();var d=$(document).height();a+200>=d&&f.showLoad&&(0==f.choose?f.loadNearby():f.loadByCity())}}b.prototype.reset=function(){this.offset=0;this.spots=[];0==this.choose?this.loadNearby():this.loadByCity()};b.prototype.parseRadius=function(){this.radius=parseInt(this.radius.toString())};b.prototype.loadByCity=function(){var a=this;this.loading=!0;this.http.get(jsRoutes.controllers.Application.findByCity(this.phrase,this.offset).absoluteURL()).success(function(b,d){a.spots=a.spots.concat(b);
a.offset+=10;a.loading=!1;a.offlineService.setOnline();a.saveOffline();a.spots.length==a.offset&&(a.showLoad=!0)}).error(function(b,d){a.loading=!1;a.offlineService.setOffline();a.loadOffline()})};b.prototype.loadNearby=function(){var a=this;this.loading=!0;this.http.get(jsRoutes.controllers.Application.findNearby(this.lat,this.lon,1E3*this.radius,this.offset).absoluteURL()).success(function(b,d){a.spots=a.spots.concat(b);a.offset+=10;a.loading=!1;a.offlineService.setOnline();a.saveOffline();a.spots.length==
a.offset&&(a.showLoad=!0)}).error(function(b,d){a.loading=!1;a.offlineService.setOffline();a.loadOffline()})};b.prototype.redirect=function(a){this.location.path("/app/spot/"+a)};b.prototype.loadOffline=function(){var a=this;this.showLoad=!1;for(var b=0;10>b;b++)localforage.getItem("spot-"+b,function(b){b&&a.timeout(function(){return a.spots.push(b)})})};b.prototype.saveOffline=function(){this.spots.forEach(function(a,b,d){localforage.setItem("spot-"+b,a)})};b.$inject="$scope $http $location $window $resource $timeout offlineService geoService".split(" ");
return b}();c.HomeCtrl=e})(app||(app={}));
(function(c){var e=function(){function b(a,b,d,c,e,l,g,h){var f=this;this.media=[];this.pricing=[];this.pointSet=this.edit=this.loading=!1;a.vm=this;this.scope=a;this.http=d;this.location=c;this.window=e;this.timeout=l;this.geoService=g;this.offlineService=h;this.infrastructure=INFRASTRUCTURE;this.offlineService.isOnline()?(a=b.id||"new","new"===a?this.createSpot():this.loadSpot(a)):this.location.path("/app/offline");this.scope.$on("geocode",function(a,b,d){return f.geocodeFinished(b,d)})}b.prototype.addMedia=
function(){this.media.push(new c.Media)};b.prototype.deleteMedia=function(a){this.media.splice(a,1)};b.prototype.addPricing=function(){this.pricing.push(new c.Pricing(null,0))};b.prototype.deletePricing=function(a){this.pricing.splice(a,1)};b.prototype.showSummary=function(){this.loading=!0;this.geoService.geocode(this.spot.address)};b.prototype.toggleInfrastructure=function(a){var b=this.spot.infrastructure.indexOf(a);if(0<=b)return this.spot.infrastructure.splice(b,1),!1;this.spot.infrastructure.push(a);
return!0};b.prototype.geocodeFinished=function(a,b){b?(this.window.alert(b),this.loading=!1):this.edit?(this.spot.address=a,this.save()):(this.spot.address=a,this.insert())};b.prototype.insert=function(){var a=this;this.loading=!0;this.handleMedias();this.handlePricings();this.http.post(jsRoutes.controllers.Application.createSpot().absoluteURL(),this.spot).success(function(b,d){a.spot=b;a.location.path("/app/spot/"+a.spot.id)}).error(function(b,d){a.loading=!1})};b.prototype.save=function(){var a=
this;this.loading=!0;this.handleMedias();this.handlePricings();this.http.put(jsRoutes.controllers.Application.updateSpot().absoluteURL(),this.spot).success(function(b,d){a.spot=b;a.location.path("/app/spot/"+a.spot.id)}).error(function(a,b){})};b.prototype.handleMedias=function(){for(var a=this.media.length;a--;)this.media[a].url||this.media.splice(a,1);this.spot.media=this.spot.media.concat(this.media)};b.prototype.handlePricings=function(){for(var a=this.pricing.length;a--;)this.pricing[a].description||
this.pricing.splice(a,1);this.spot.pricing=this.spot.pricing.concat(this.pricing)};b.prototype.createSpot=function(){this.edit=!1;this.spot=new c.Spot;this.spot.address=new c.Address;this.createMap()};b.prototype.loadSpot=function(a){var b=this;this.pointSet=this.edit=!0;this.http.get(jsRoutes.controllers.Application.retrieveSpot(a).absoluteURL()).success(function(a,c){b.spot=a;console.log(b.spot);b.spot||b.location.path("/app/404").replace()}).error(function(a,c){b.location.path("/app/404").replace()})};
b.prototype.createMap=function(){var a=this,b=null;this.geoService.current().then(function(a){d.setCenter(new google.maps.LatLng(a.coords.latitude,a.coords.longitude))});var d=new google.maps.Map(document.getElementById("map"),{center:{lat:48.20817400000001,lng:16.373819},zoom:15});google.maps.event.addListener(d,"click",function(c){var e=c.latLng.lat(),l=c.latLng.lng();a.spot.address.position.lat=e;a.spot.address.position.lon=l;a.timeout(function(){return a.pointSet=!0});null==b?b=new google.maps.Marker({position:c.latLng,
map:d}):b.setPosition(c.latLng)})};b.$inject="$scope $stateParams $http $location $window $timeout geoService offlineService".split(" ");return b}();c.EditSpotCtrl=e})(app||(app={}));
(function(c){var e=function(){function b(a,b,d,c,e,l,g){var h=this;this.hasImage=!1;this.slideIndex=0;this.finished=!1;this.scope=a;this.scope.vm=this;this.http=b;this.location=d;this.window=l;this.sce=e;this.offlineService=g;this.oratio=this.sce.trustAsResourceUrl("//www.orat.io/js/widget/stmt.inc.min.js");this.loadSpot(c.id||"0");this.scope.$on("online",function(a){h.loadFinish()})}b.prototype.loadSpot=function(a){var b=this;localforage.getItem(a,function(d){b.spot=d;b.spot?(b.offlineService.isOnline()&&
...
b.prototype.handleUpload=function(a,b){var d=this;console.log(a);this.loading=!0;for(var c=0;c<a.length;c++)this.myScope.upload=this.upload.upload({url:SERVER+"/upload",method:"POST",file:a[c]}).progress(function(a){return console.log("percent: "+100*a.loaded/a.total)}).success(function(a,b,c,e){console.log(a.url);d.myScope.picture.url=SERVER+"/res/"+a.url;d.loading=!1}).error(function(){return d.window.alert("Unfortunately an error occurred. Please try again later.")})};return b}();c.ImgUpload=e})(app||
(app={}));
