...
var _wA = function(r){return {ajax:function(c){c=c||{};c.url=r.url;c.type=r.method;return jQuery.ajax(c)}, method:r.method,type:r.method,url:r.url,absoluteURL: function(s){return _s('http',s)+SERVER+':9000'+r.url},webSocketURL: function(s){return _s('ws',s)+SERVER+':9000'+r.url}}}
